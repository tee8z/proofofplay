...
echo "   scp $WG_DIR/server-private.key root@${SERVER_IP}:/opt/proofofplay/secrets/wg-private-key"
echo "   ssh root@${SERVER_IP} 'chmod 600 /opt/proofofplay/secrets/wg-private-key'"
echo ""
